...
import makkamishi from '../eventsinnerimages/letsdomakamishi.jpg'
        ...
        <Categories/>
            ...
            <div className=" aboutevent ">
                    ...
                    <div className="survivorsticky ps-5 p-2 d-flex justify-content-between">
                        <div className="fs-3 fw-bold"> Let's do Makkamishi</div>
                        <div className="beshare fs-5 pt-1 px-2" style={{borderRadius:"50%",backgroundColor:"lightgrey"}}> <BsShare /> </div>
                    </div>

                    <div className="d-flex mt-4 ms-5">
                        <img src={makkamishi} alt="" style={{height:"100%",width:"95%",borderRadius:"15px"}} />
                    </div>  
                    ...
                    <div className="container d-flex justify-content-between p-2 ms-5 my-2"style={{width:"90%"}}>
                        ...
                        <div className=" px-1 fw-semibold">3 are intrested</div>
                    ...
                    <div className=" ms-5 ps-2" style={{width:"90%"}}>
                            <div className=" ">
                                ...
                                <p className='' style={{fontSize:"16px", color:"rgb(64,64,64)"}}> A tamil line up show Featuring Big Basky, US based comedian all the way from Dallas, alongside some extremely funny comics in different cities. </p>
                                <p className='' style={{fontSize:"16px", color:"rgb(64,64,64)"}}> Coimbatore: Chockalingam  </p>
                                <p className='' style={{fontSize:"16px", color:"rgb(64,64,64)"}}> Chennai: Mayandi, Divyaanand, Karthy and Selvakumaran </p>
                                <p className='' style={{fontSize:"16px", color:"rgb(64,64,64)"}}> Bangalore: Arun Sriram and Mownicaa Mani </p>
                                <p className='' style={{fontSize:"16px", color:"rgb(64,64,64)"}}> Come join us for an hilarious evening. </p>
                ...
                <div className=" ticketdetails mt-3 ms-0" style={{width:"100%", borderRadius:"16px 16px",border:"1px solid rgb(208,213,230 )" ,padding:'20px 20px 4px' }}>
                        ...
                        <div className="">
                           ...
                           <div className=" ps-2 mt-3 d-flex " style={{width:"100%"}}> 
                                <img src={calendar} alt="" className='mt-1' style={{height:"20px", width:"7.1%", objectFit:"cover"}} /> <span> <div className="px-2 " style={{fontSize:"14px",paddingTop:"5px"}}>Fri 13 Jun 2025 - Sun 22 Jun 2025</div> </span> 
                           </div>
                           <div className=" ps-2 mt-3 d-flex " style={{width:"100%"}}> 
                           ...
                           <div className=" ps-2 mt-3 d-flex " style={{width:"100%"}}> 
                                <img src={duration} alt="" className='mt-1' style={{height:"21px", width:"7.1%", objectFit:"cover"}} /> <span> <div className="px-2 " style={{fontSize:"14px",paddingTop:"5px"}}>1 hour 10 minutes</div> </span> 
                           </div>
                           <div className=" ps-2 mt-3 d-flex " style={{width:"100%"}}> 
