...
import extradinary from '../eventsinnerimages/extra-ordinary.jpg'
import like from '../eventsinnerimages/like_icon.png'
import manoj from '../eventdetails/eventdetailsimage/manoj.jpg'
        ...
        {/* <div className=" d-flex justify-content-center py-2 border border-black">*/}
            ...
            <div className=" aboutevent ">
                    ...
                    <div className="survivorsticky ps-5 p-2 d-flex justify-content-between">
                        <div className="fs-3 fw-bold">EXTRA ORDINARY - Standup Comedy Ft. MANOJ PRABAKAR</div>
                        <div className="beshare fs-5 pt-1 px-2" style={{borderRadius:"50%",backgroundColor:"lightgrey"}}> <BsShare /> </div>
                    </div>

                    <div className="d-flex mt-4 ms-5">
                        <img src={extradinary} alt="" style={{height:"100%",width:"95%",borderRadius:"15px"}} />
                    </div>  
                    ...
                    <div className="container d-flex justify-content-between p-2 ms-5 my-2"style={{width:"90%"}}>
                        ...
                        <div className=" px-1 fw-semibold">182 are intrested</div>
                        <div className="px-2"style={{borderRadius:"8px",color:"red",border:"1px solid red",cursor:"pointer"}}>I'm intrested</div>
                        </div>
                    </div> 

                   <div className=" ms-5 ps-2" style={{width:"80%"}}>
                            <div className=" ">
                                <h3 className='fs-4 fw-semibold'>About The Event</h3>
                                <p className='' style={{fontSize:"16px", color:"rgb(64,64,64)"}}> Welcome to Extra-Ordinary by Manoj Prabakar. This is a standup comedy show about a man who’s ordinary in every way except for his ideas. One of India’s biggest comedy stars, but he’ll never sell as many tickets as his father—a bus conductor. A first-generation graduate, he hilariously stumbles through wokeness, post-colonial English, and life’s biggest debates. With clueless confidence, he takes on questions nobody asked—like or which language truly came first or the song Unstoppable by Sia is just Indian motivational wisdom. His thoughts are sometimes revolutionary, sometimes regressive. Come watch a man catch up to modernity, badly. P.S. This show will be featured at the Edinburgh Fringe festival, the biggest comedy festival in the world, in August 2025. First South Indian comedian to do this. You cannot miss this international act. </p>
                    ...
                    <div className="mt-2 ms-5">
                        ...
                        <div className=" p-1" style={{width:"19.7%",height:"100%"}}>
                            <img src={manoj} alt="" style={{width:"150px",height:"200px",borderRadius:"10px",objectFit:"cover"}} />
                        </div>
                        <div className=" w-75">
                            <div className=" w-25 fs-5 fw-medium" style={{color:"rgb(64, 64, 64)",lineHeight:"25px"}}>Manoj Prabakar</div>
                        </div>
                        <div className=" w-75">
                            <div className=" w-25 fs-6" style={{color:"rgb(82, 82, 82)",lineHeight:"20px"}}>Writter</div>
                        </div>
                ...
                <div className=" ticketdetails mt-3 ms-0" style={{width:"100%", borderRadius:"16px 16px",border:"1px solid rgb(208,213,230 )" ,padding:'20px 20px 4px' }}>
                        ...
                        <div className="">
                           ...
                           <div className=" ps-2 mt-3 d-flex " style={{width:"100%"}}> 
                                <img src={calendar} alt="" className='mt-1' style={{height:"20px", width:"7.1%", objectFit:"cover"}} /> <span> <div className="px-2 " style={{fontSize:"14px",paddingTop:"5px"}}>Sat 14 Jun 2025 - Sun 29 Aug 2025</div> </span> 
                           </div>
                           <div className=" ps-2 mt-3 d-flex " style={{width:"100%"}}> 
                                <img src={time} alt="" className='mt-1' style={{height:"21px", width:"7.1%", objectFit:"cover"}} /> <span> <div className="px-2 " style={{fontSize:"14px",paddingTop:"5px"}}>8:00 PM</div> </span> 
                           </div>
                           <div className=" ps-2 mt-3 d-flex " style={{width:"100%"}}> 
                                <img src={duration} alt="" className='mt-1' style={{height:"21px", width:"7.1%", objectFit:"cover"}} /> <span> <div className="px-2 " style={{fontSize:"14px",paddingTop:"5px"}}>1 hour 20 minutes</div> </span> 
                           </div>
                           <div className=" ps-2 mt-3 d-flex " style={{width:"100%"}}> 
                                <img src={agelimit} alt="" className='mt-1' style={{height:"22px", width:"7.1%", objectFit:"cover"}} /> <span> <div className="px-2 " style={{fontSize:"14px",paddingTop:"5px"}}>Age Limit - 16yrs +</div> </span> 
                           </div>
                           <div className=" ps-2 mt-3 d-flex " style={{width:"100%"}}> 
                                <img src={language} alt="" className='mt-1' style={{height:"21px", width:"7.1%", objectFit:"cover"}} /> <span> <div className="px-2 " style={{fontSize:"14px",paddingTop:"5px"}}>English</div> </span> 
                           </div>
                           <div className=" ps-2 mt-3 d-flex " style={{width:"100%"}}> 
                                <img src={genre} alt="" className='mt-1' style={{height:"21px", width:"7.1%", objectFit:"cover"}} /> <span> <div className="px-2 " style={{fontSize:"14px",paddingTop:"5px"}}>Comedy</div> </span> 
                           </div>
