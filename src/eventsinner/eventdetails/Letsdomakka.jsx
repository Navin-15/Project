...
import letsdomakka from '../eventsinnerimages/letsdomakka.jpg'
        ...
        <Categories/>
            ...
            <div className=" aboutevent ">
                    ...
                    <div className="survivorsticky ps-5 p-2 d-flex justify-content-between">
                        <div className="fs-3 fw-bold"> Let's do Makkamishi- Standup ft.Chocku and Basky </div>
                        <div className="beshare fs-5 pt-1 px-2" style={{borderRadius:"50%",backgroundColor:"lightgrey"}}> <BsShare /> </div>
                    </div>

                    <div className="d-flex mt-4 ms-5">
                        <img src={letsdomakka} alt="" style={{height:"100%",width:"95%",borderRadius:"15px"}} />
                    </div>  
                    ...
                    <div className="container d-flex justify-content-between p-2 ms-5 my-2"style={{width:"90%"}}>
                        ...
                        <div className=" px-1 fw-semibold">1 are intrested</div>
                    ...
                    <div className=" ms-5 ps-2" style={{width:"80%"}}>
                            <div className=" ">
                                ...
                                <p className='' style={{fontSize:"16px", color:"rgb(64,64,64)"}}> "Lets do makkamishi" - A Stand-Up Comedy night  by Chocku and Basky </p>
                                <p className='' style={{fontSize:"16px", color:"rgb(64,64,64)"}}>  Step into the hilarious world of two madurai people "Chocku" and "basky" where they take you on a laugh-filled journey through their life, blending wit and nostalgia with spot-on observations. From the unique charm of their hometown Madurai to the chaos of their school and college days, their love affair with cinema, and the quirks of IT life, their stories are as relatable as they are entertaining.  </p>
                ...
                <div className=" ticketdetails mt-3 ms-0" style={{width:"100%", borderRadius:"16px 16px",border:"1px solid rgb(208,213,230 )" ,padding:'20px 20px 4px' }}>
                        ...
                        <div className="">
                           ...
                           <div className=" ps-2 mt-3 d-flex " style={{width:"100%"}}> 
                                <img src={calendar} alt="" className='mt-1' style={{height:"20px", width:"7.1%", objectFit:"cover"}} /> <span> <div className="px-2 " style={{fontSize:"14px",paddingTop:"5px"}}>Fri 13 Jun 2025</div> </span> 
                           </div>
                           <div className=" ps-2 mt-3 d-flex " style={{width:"100%"}}> 
                                <img src={time} alt="" className='mt-1' style={{height:"21px", width:"7.1%", objectFit:"cover"}} /> <span> <div className="px-2 " style={{fontSize:"14px",paddingTop:"5px"}}>7:30 PM</div> </span> 
                           </div>
                           <div className=" ps-2 mt-3 d-flex " style={{width:"100%"}}> 
                           ...
                           <div className=" ps-2 mt-3 d-flex " style={{width:"100%"}}> 
                                <img src={agelimit} alt="" className='mt-1' style={{height:"20px", width:"7.1%", objectFit:"cover"}} /> <span> <div className="px-2 " style={{fontSize:"14px",paddingTop:"5px"}}>Age Limit - 12yrs +</div> </span> 
                           </div>
                           <div className=" ps-2 mt-3 d-flex " style={{width:"100%"}}> 
                        ...
                        <div className=" mt-3">
                            <div className="d-flex justify-content-between align-items-center" style={{boxSizing:"border-box",width:"100%",height:'56px',padding:"18px,16px",background:"rgb(255, 255, 255)"}}>
                                ...
                                <div className="">
                                    <div className="">
                                        <div className=" fw-semibold" style={{fontSize:"16px"}}>$299 onwards</div>
                                    </div>
                                    <div className="">
