...
import eightbypraveen from '../eventsinnerimages/8bypraveenkumar.jpg'
import like from '../eventsinnerimages/like_icon.png'
import praveen from '../eventdetails/eventdetailsimage/praveen.jpg'
        ...
        <Categories/>
            ...
            <div className=" aboutevent ">
                    ...
                    <div className="survivorsticky ps-5 p-2 d-flex justify-content-between">
                        <div className="fs-3 fw-bold">8 by Praveen Kumar</div>
                        <div className="beshare fs-5 pt-1 px-2" style={{borderRadius:"50%",backgroundColor:"lightgrey"}}> <BsShare /> </div>
                    </div>

                    <div className="d-flex mt-4 ms-5">
                        <img src={eightbypraveen} alt="" style={{height:"100%",width:"95%",borderRadius:"15px"}} />
                    </div>  
                    ...
                    <div className="container d-flex justify-content-between p-2 ms-5 my-2"style={{width:"90%"}}>
                        ...
                        <div className=" px-1 fw-semibold">694 are intrested</div>
                    ...
                    <div className=" ms-5 ps-2" style={{width:"80%"}}>
                            <div className=" ">
                                ...
                                <p className='' style={{fontSize:"16px", color:"rgb(64,64,64)"}}> Step into the world of ‘8’ – Praveen Kumar’s `8th` stand-up special, inspired by his favorite icon, Superstar Rajinikanth. Just like Rajinikanth divided life into `8` chapters in ‘Baasha’, Praveen takes you on a hilarious journey through `8` stories from `8` distinct stages of his own life.</p>
                                <p className='' style={{fontSize:"16px", color:"rgb(64,64,64)"}}> Praveen Kumar is one of India’s leading standup comedians. With 15 million+ views on his YouTube page. He was also seen as a judge on the hit comedy property Comicstaan on Amazon Prime Video.</p>
                                <p className='' style={{fontSize:"16px", color:"rgb(64,64,64)"}}> The show is clean and open to the whole family. Admission is allowed only for ages above 5.</p>
                    ...
                    <div className="mt-2 ms-5">
                        ...
                        <div className=" p-1" style={{width:"19.7%",height:"100%"}}>
                            <img src={praveen} alt="" style={{width:"150px",height:"200px",borderRadius:"10px",objectFit:"cover"}} />
                        </div> 
                        <div className=" w-75">
                            <div className=" w-25 fs-5 fw-medium" style={{color:"rgb(64, 64, 64)",lineHeight:"25px"}}>Praveen Kumar</div>
                        </div>
                         <div className=" w-75">
                            <div className=" w-25 fs-6" style={{color:"rgb(82, 82, 82)",lineHeight:"20px"}}>Actor,writer,Producer,...</div>
                        </div>
                ...
                <div className=" ticketdetails mt-3 ms-0" style={{width:"100%", borderRadius:"16px 16px",border:"1px solid rgb(208,213,230 )" ,padding:'20px 20px 4px' }}>
                        ...
                        <div className="">
                           ...
                           <div className=" ps-2 mt-3 d-flex " style={{width:"100%"}}> 
                                <img src={calendar} alt="" className='mt-1' style={{height:"20px", width:"7.1%", objectFit:"cover"}} /> <span> <div className="px-2 " style={{fontSize:"14px",paddingTop:"5px"}}>Sat 21 Jun 2025 - Sat 5 Jul 2025</div> </span> 
                           </div>
                           <div className=" ps-2 mt-3 d-flex " style={{width:"100%"}}> 
                           ...
                           <div className=" ps-2 mt-3 d-flex " style={{width:"100%"}}> 
                                <img src={duration} alt="" className='mt-1' style={{height:"21px", width:"7.1%", objectFit:"cover"}} /> <span> <div className="px-2 " style={{fontSize:"14px",paddingTop:"5px"}}>1 Hour 40 Minutes</div> </span> 
                           </div>
                           <div className=" ps-2 mt-3 d-flex " style={{width:"100%"}}> 
                                <img src={agelimit} alt="" className='mt-1' style={{height:"20px", width:"7.1%", objectFit:"cover"}} /> <span> <div className="px-2 " style={{fontSize:"14px",paddingTop:"5px"}}>Age Limit - 15yrs+</div> </span> 
                           </div>
                           <div className=" ps-2 mt-3 d-flex " style={{width:"100%"}}> 
                                <img src={language} alt="" className='mt-1' style={{height:"20px", width:"7.1%", objectFit:"cover"}} /> <span> <div className="px-2 " style={{fontSize:"14px",paddingTop:"5px"}}>Tamil</div> </span> 
                           </div>
                           <div className=" ps-2 mt-3 d-flex " style={{width:"100%"}}> 
                           ...
                           <div className=" ps-2 my-3 d-flex " style={{width:"100%"}}> 
                                <img src={location} alt="" className='mt-1' style={{height:"22px", width:"7.1%", objectFit:"cover"}} /> <span> <div className="ps-2 " style={{fontSize:"14px",paddingTop:"5px"}}>Coindia Training: Coimbatore</div> </span> 
                        ...
                        <div className="" style={{fontSize:"14px", lineHeight:"20px"}}>
                            <div className="text-danger w-50 ms-5" style={{cursor:"pointer"}}>View 2 Other Venues</div>
                        </div>
                        ...
                        <div className=" mt-3">
                            <div className="d-flex justify-content-between align-items-center" style={{boxSizing:"border-box",width:"100%",height:'56px',padding:"18px,16px",background:"rgb(255, 255, 255)"}}>
                                ...
                                <div className="">
                                    <div className="">
                                        <div className=" fw-semibold" style={{fontSize:"16px"}}>$550 onwards</div>
                                    </div>
                                    <div className="">
                                        <div className="text-warning fw-medium">Filling Fast</div>
                                    </div>
                                </div>
