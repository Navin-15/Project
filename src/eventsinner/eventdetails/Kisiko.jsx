...
import kiskodesktop from '../eventsinnerimages/kiskodesktop.jpg'
import like from '../eventsinnerimages/like_icon.png'
import anubhav from '../eventdetails/eventdetailsimage/anubhav.jpg'
        ...
        <Categories/>
            ...
            <div className=" aboutevent ">
                    ...
                    <div className="survivorsticky ps-5 p-2 d-flex justify-content-between">
                        <div className="fs-3 fw-bold">Kisi Ko Batana Mat Ft. Anubhav Singh Bassi </div>
                        <div className="beshare fs-5 pt-1 px-2" style={{borderRadius:"50%",backgroundColor:"lightgrey"}}> <BsShare /> </div>
                    </div>

                    <div className="d-flex mt-4 ms-5">
                        <img src={kiskodesktop} alt="" style={{height:"100%",width:"95%",borderRadius:"15px"}} />
                    </div>  
                    ...
                    <div className="container d-flex justify-content-between p-2 ms-5 my-2"style={{width:"90%"}}>
                        ...
                        <div className=" px-1 fw-semibold">83.7K are intrested</div>
                    ...
                    <div className=" ms-5 ps-2" style={{width:"80%"}}>
                            <div className=" ">
                                ...
                                <p className='' style={{fontSize:"16px", color:"rgb(64,64,64)"}}> After the great success of his previous show Bas kar bassi, Anubhav Singh Bassi is coming back to perform live on stage. This time, he will bring a whole new set of funny stories and jokes that will keep you entertained. Get ready to enjoy an exciting and hilarious performance that will make you laugh uncontrollably and leave you in high spirits.</p>
                    ...
                    <div className="mt-2 ms-5">
                        ...
                        <div className=" p-1" style={{width:"19.7%",height:"100%"}}>
                            <img src={anubhav} alt="" style={{width:"150px",height:"200px",borderRadius:"10px",objectFit:"cover"}} />
                        </div> 
                        <div className=" w-75">
                            <div className=" w-25 fs-5 fw-medium" style={{color:"rgb(64, 64, 64)",lineHeight:"25px"}}>Anubhav Singh...</div>
                        </div>
                         <div className=" w-75">
                ...
                <div className=" ticketdetails mt-3 ms-0" style={{width:"100%", borderRadius:"16px 16px",border:"1px solid rgb(208,213,230 )" ,padding:'20px 20px 4px' }}>
                        ...
                        <div className="">
                           ...
                           <div className=" ps-2 mt-3 d-flex " style={{width:"100%"}}> 
                                <img src={calendar} alt="" className='mt-1' style={{height:"20px", width:"7.1%", objectFit:"cover"}} /> <span> <div className="px-2 " style={{fontSize:"14px",paddingTop:"5px"}}>Fri 20 Jun 2025 - Sun 27 Jun 2025</div> </span> 
                           </div>
                           <div className=" ps-2 mt-3 d-flex " style={{width:"100%"}}> 
                                <img src={time} alt="" className='mt-1' style={{height:"21px", width:"7.1%", objectFit:"cover"}} /> <span> <div className="px-2 " style={{fontSize:"14px",paddingTop:"5px"}}>9:00 PM</div> </span> 
                           </div>
                           <div className=" ps-2 mt-3 d-flex " style={{width:"100%"}}> 
                                <img src={duration} alt="" className='mt-1' style={{height:"21px", width:"7.1%", objectFit:"cover"}} /> <span> <div className="px-2 " style={{fontSize:"14px",paddingTop:"5px"}}>2 Hour</div> </span> 
                           </div>
                           <div className=" ps-2 mt-3 d-flex " style={{width:"100%"}}> 
                           ...
                           <div className=" ps-2 mt-3 d-flex " style={{width:"100%"}}> 
                                <img src={language} alt="" className='mt-1' style={{height:"20px", width:"7.1%", objectFit:"cover"}} /> <span> <div className="px-2 " style={{fontSize:"14px",paddingTop:"5px"}}>Hindi</div> </span> 
                           </div>
                           <div className=" ps-2 mt-3 d-flex " style={{width:"100%"}}> 
                           ...
                           <div className=" ps-2 my-3 d-flex " style={{width:"100%"}}> 
                                <img src={location} alt="" className='mt-1' style={{height:"22px", width:"7.1%", objectFit:"cover"}} /> <span> <div className="ps-2 " style={{fontSize:"14px",paddingTop:"5px"}}>Sir Mutha Venkatasubba Rao Concert Hall: Chennai</div> </span> 
                        ...
                        <div className="" style={{fontSize:"14px", lineHeight:"20px"}}>
                            <div className="text-danger w-50 ms-5" style={{cursor:"pointer"}}>View 11 Other Venues</div>
                        </div>
                        ...
                        <div className=" mt-3">
                            <div className="d-flex justify-content-between align-items-center" style={{boxSizing:"border-box",width:"100%",height:'56px',padding:"18px,16px",background:"rgb(255, 255, 255)"}}>
                                ...
                                <div className="">
                                    <div className="">
                                        <div className=" fw-semibold" style={{fontSize:"16px"}}>$999 onwards</div>
                                    </div>
                                    <div className="">
