...
//     if (num === 1) setVehicleImg(bicycle)
//     else if (num === 2) setVehicleImg(scooter)
//     else if (num === 3) setVehicleImg(auto)
//     else if (num === 4) setVehicleImg(smallcar)
//     else if (num === 5) setVehicleImg(flatcar)
//     else if (num === 6) setVehicleImg(flatcar)
//     else if (num === 7) setVehicleImg(flatcar)
//     else if (num === 8) setVehicleImg(van)
//     else if (num === 9) setVehicleImg(van)
//     else if (num === 10) setVehicleImg(van)
//     else setVehicleImg(bicycle) // default hover
//   }
...
//           {/* your price/status and button divs */}
//         </div>
//       </div>
//     </div>
//   )
...
//     else if (num === 3) setVehicleImg(auto)
//     else if (num === 4) setVehicleImg(smallcar)
//     else if (num === 5 || num === 6 || num === 7) setVehicleImg(flatcar)
//     else if (num === 8 || num === 9 || num === 10) setVehicleImg(van)
//     else setVehicleImg(bicycle)
//   }
...
//final correct code of Movieseatselection
import React, { useState } from 'react'
import '../loading/Movieseatselection.css'
import bicycle from './seatimages/bicycle.jpg'
import scooter from './seatimages/scooter.jpg'       
