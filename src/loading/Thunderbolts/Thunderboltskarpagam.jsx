...
function Thunderboltskarpagam() {

  const navigate = useNavigate();

    const handleSeatLayoutKarpagam = () => {
    navigate('/thunderbolts/buytickets/karpagamseatselection/karpagamcinemaseatlayout');
  };
      ...
      <div className="childd">
        ...
        <div className="childdtwo">
          ...
          <div className="grandchilldfour mt-3 d-flex justify-content-center">
            <div onClick={handleSeatLayoutKarpagam} className="selectseatbutton">
...
export default Thunderboltskarpagam
