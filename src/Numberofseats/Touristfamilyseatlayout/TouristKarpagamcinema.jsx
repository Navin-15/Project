...
//                         <span style={{fontSize:"13px",fontWeight:"700",color:"rgb(88, 86, 86)"}}> Karpagam Theatres 4K Dolby Atmos: Coimbatore </span>
...
const Seatlayout = () => {
  ...
  const handlepay = () => {
    ...
    const TheaterName = "Karpagam Theatres 4K Dolby Atmos: Coimbatore";
