...
//                 <div className=" p-2  ">
//                     <div className="">
//                         <a href="" className='text-dark' style={{textDecoration:"none"}}>Touristfamily</a>
...
//   const toggleSeat = (row, seatNumber, category) => {
...
//     } else {
//       setSelectedSeats(prev => [...prev, { id: seatId, row, seatNumber, category }]);
//     }
//   };
...
//       ? 'seatno availabledouble selected'
//       : 'seatno availabledouble';
//   };

//   const totalAmount = selectedSeats.reduce((acc, seat) => acc + seatPrices[seat.category], 0);

//   const handlePay = () => {
//     alert(`You have booked: ${selectedSeats.map(s => `${s.row}${s.seatNumber}`).join(', ')}\nTotal: ₹${totalAmount}`);
//     // Proceed with payment logic...
//   };

//   return (
//     <>
//       {/* HEADER UI remains unchanged */}
//       {/* Gold Row M example — replicate for other rows with correct row/category */}
//       <div className="seeat container">
//         <div className="blocklayout goldlayout">
//           <table>
//             <tbody>
//               <tr><td><div className="tirename">Rs.130 Gold</div></td></tr>
//               <tr className='d-flex'>
//                 <div className="seatR">M</div>
//                 <td className='SRow-1'>
//                   {[...Array(23)].map((_, i) => {
...
//                     return (
//                       <div className="seatempty" key={`M-${seatNumber}`}>
//                         <a
//                           className={getSeatClass("M", seatNumber)}
//                           href="#"
//                           onClick={(e) => {
//                             e.preventDefault();
//                             toggleSeat("M", seatNumber, 'gold');
//                           }}
//                         >
//                           {seatNumber}
//                         </a>
...
//       {/* Booking Summary */}
//       <div className="booking-summary bg-white p-3 mt-3 text-center" style={{ boxShadow: "0 -2px 8px rgba(0,0,0,0.1)" }}>
//         <h5>Booking Summary</h5>
//         <p>Selected Seats: {selectedSeats.map(s => `${s.row}${s.seatNumber}`).join(', ') || 'None'}</p>
//         <p>Total Price: ₹{totalAmount}</p>
//         <button className="btn btn-success" onClick={handlePay} disabled={selectedSeats.length === 0}>Pay ₹{totalAmount}</button>
//       </div>
//     </>
//   );
// };
...
// const ROWS = {
//   platinum: ['A','B','C','D','E','F','G','H','I','J','K'],
//   gold: ['L', 'M', 'N', 'O'],
//   silver: ['P']
// };
...
//   const [selectedTime, setSelectedTime] = useState("7:00 PM"); // default showtime
...
//       const allBooked = response.data.flatMap(booking => booking.seats); // returns array of all booked seat IDs
...
// //   console.log("🪑 Selected Seats:", selectedSeats.map(s => s.id).join(", "));
// //   console.log("💺 Seat Types & Prices:", selectedSeats);
// //   console.log("💰 Total Price:", totalPrice);
// //   console.log("📅 Booking Date:", selectedDate.toLocaleDateString());
// //   console.log("⏰ Show Time:", selectedTime);
...
// //     console.log("✅ Booking saved to MongoDB:", response.data);

// //     // Mark selected seats as booked and clear selection
// //     setBookedSeats(prev => [...prev, ...selectedSeats.map(s => s.id)]);
// //     setSelectedSeats([]);
...
// //       // Mark seats as booked and reset selected seats
// //       setBookedSeats(prev => [...prev, ...selectedSeats.map(s => s.id)]);
// //       setSelectedSeats([]);
...
// //     alert("Something went wrong while saving the booking. Please try again.");
// //   }
// // };
// //============================================================================================
...
//   // 👉 Immediately mark these seats as booked in UI (orange + cursor-not-allowed)
//   setBookedSeats(prev => [...prev, ...selectedSeats.map(s => s.id)]);

//   // Optional: clear selected state to avoid confusion
//   setSelectedSeats([]);
...
// //   if (isBooked) return `seatno booked-seat px-2 text-center`;
...
//   if (isBooked) return 'seatno orange-disabled';   // ✅ This disables the seat
//   if (isSelected) return 'seatno selected-seat px-2 text-center';
//   return 'seatno availabledouble px-1 text-center';
// };
...
//       <div className="seeat container">
//         <div className="block ">
//           {/* Render Seat Blocks by Category */}
...
//                         {[...Array(23).keys()].map(i => {
//                           const seatNo = 23 - i;
//                           if (seatNo === 17 || seatNo === 7) return <div className="seatempty" key={i}>&nbsp;</div>; // middle space
//                           return (
...
//           </div>
//           <div className="w-25">
//             <div className="seatempty"><a className='seatno availabledouble' style={{ padding: "9px", backgroundColor: "orange", border: "none" }} href="#"></a></div>
//             Sold
//           </div>
//         </div>
//       </div>
...
//       {/* Booking Summary and Pay Button */}
//       {/* <div className="container bg-secondary mt-3 p-3 rounded">
//         <h5>Booking Summary</h5>
//         <p><strong>Seats Selected:</strong> {selectedSeats.map(s => s.id).join(", ") || "None"}</p>
//         <p><strong>Total Price:</strong> ₹{totalPrice}</p>
//         <button onClick={handlepay} className="btn btn-success w-100" disabled={selectedSeats.length === 0}>
//           Pay ₹{totalPrice} 
//         </button> 
//       </div> */}
//     </>
